...
const ServiceImgs: ServiceDetail[] = [
  {
    ...
    text: 'この文章はダミーかもしれない。この文章はダミーかもしれない。この文章はダミーかもしれない。この文章は',
    alt: '',
    className: 'rounded-80',
  },
  {
    ...
    text: 'この文章はダミーです。文字の大きさ、量、字間、行間等を確認するために入れてこ',
    alt: '',
    className: 'rounded-80',
  },
  {
    src: Main_3,
    title: 'この文章はダミーかもしれない',
    text: 'この文章はダミーかもしれない。この文章はダミーかもしれない。この文章はダミーかもしれない。この文章',
    alt: '',
    className: 'rounded-80',
  },
  {
